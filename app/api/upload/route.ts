...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    console.error('Error writing file to temporary storage:', writeError);
    return NextResponse.json({ success: false, message: 'Error writing file to temporary storage' });
  }
  ...
  try {
    ...
    return NextResponse.json({ success: false, message: 'Error uploading file', error: uploadError });
  }
}