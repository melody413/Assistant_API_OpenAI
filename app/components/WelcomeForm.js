    ...
    <div className="border-gray-500 bg-gray-200 sm:mx-0 mx-5 mt-20 max-w-screen-md rounded-md border-2 sm:w-full">
      <div className="flex flex-col space-y-4 p-7 sm:p-10">
        <h1 className="text-lg font-semibold text-black">
          Welcome to DevCodeBase Assistant.
        </h1>
...
></textarea>
          ...
          <div>
            <button
              ...
              className={`p-1 border border-gray-400 rounded-md ${assistantModel === 'gpt-4-1106-preview' ? 'bg-[#112233] text-white' : ''}`}
            >
              GPT-4
            </button>
            <button
              ...
              className={`p-1 border border-gray-400 rounded-md ${assistantModel === 'gpt-3.5-turbo-1106' ? 'bg-[#112233] text-white' : ''}`}
            >
              GPT-3.5
            </button>
          </div>
          ...
          <button
            ...
            className={`p-2 rounded-md flex justify-center items-center ${isButtonDisabled ? 'bg-gray-500 text-gray-300' : 'bg-[#112233] text-white'}`}
          >
            {isStartLoading ? <LoadingCircle /> : "Create Assistant"}
          </button>
        </form>
      </div>
    </div>
